...
$($PSStyle.Foreground.Green)lh$($PSStyle.Reset) - Lists all files, including hidden, in the current directory with detailed formatting.
...
$($PSStyle.Foreground.Green)gg$($PSStyle.Reset) - Shows git log with graph visualization.

$($PSStyle.Foreground.Green)gcl$($PSStyle.Reset) <url> - Clones a git repository.
...
$($PSStyle.Foreground.Green)su$($PSStyle.Reset) [command] - Alias for admin command.

$($PSStyle.Foreground.Green)wsll$($PSStyle.Reset) - Lists all WSL distributions and their states.

$($PSStyle.Foreground.Green)wslsd$($PSStyle.Reset) - Shuts down all WSL distributions.
